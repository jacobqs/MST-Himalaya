...
class GeoTsObject:
    ...
    def __init__(self):
        ...
        self.temperature_path = self.home_dir + '/Documents/MST Himalaya/MST-Himalaya/shyft_workspace_copy/shyft_workspace/shyft-data/netcdf/orchestration-testdata/temperature.nc'
        self.precipitation_path = self.home_dir+ '/Documents/MST Himalaya/MST-Himalaya/shyft_workspace_copy/shyft_workspace/shyft-data/netcdf/orchestration-testdata/precipitation.nc'
        self.wind_speed_path = self.home_dir + '/Documents/MST Himalaya/MST-Himalaya/shyft_workspace_copy/shyft_workspace/shyft-data/netcdf/orchestration-testdata/wind_speed.nc'
        self.rel_hum_path = self.home_dir + '/Documents/MST Himalaya/MST-Himalaya/shyft_workspace_copy/shyft_workspace/shyft-data/netcdf/orchestration-testdata/relative_humidity.nc'
        self.radiation_path = self.home_dir + '/Documents/MST Himalaya/MST-Himalaya/shyft_workspace_copy/shyft_workspace/shyft-data/netcdf/orchestration-testdata/radiation.nc'
        ...
        self.shyf_forcing_paths = [self.temperature_path, self.precipitation_path, self.rel_hum_path,
                                   self.radiation_path, self.wind_speed_path]
        # Paths to cell data
